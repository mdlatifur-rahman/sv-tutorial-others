Here’s your finalized Markdown (.md) file with 50 FPGA interview-style MCQs, now using checkbox options for answers. Each question shows four choices, the correct answer is marked with a checked box ([x]), while all others use unchecked ([ ]).  
This format is ideal for GitHub and review sessions.

---

# FPGA Interview Questions (MCQ)
...
- [x] Implement custom digital logic circuits
...
- [x] Code executes on rising edge of clock
...
- [x] To define physical pin locations and timing
...
- [x] It is volatile memory integrated in FPGA
...
- [x] Ensuring all timing constraints are met
...
- [x] Their output depends only on current inputs
...
- [ ] To implement logic
- [x] To verify design functionality
- [ ] To program the FPGA
...
- [x] Unpredictable output due to asynchronous inputs
...
- [ ] A unit of memory
- [x] A small section containing LUTs and flip-flops
- [ ] A clock generator
...
- [x] Generate and manage clock frequencies
...
- [x] Reset occurs only on clock edge
...
- [x] Runs once at simulation start
...
- [x] Placing logical blocks in specific physical locations
...
- [ ] Storing data
- [x] Controlling sequence of operations
...
- [ ] Faster operation
- [ ] Predictable timing
- [x] Unstable operation and possible oscillation
...
- [x] High-speed, on-chip memory for data storage
...
- [x] RTL is behavioral; gate-level includes timing and netlist
- [ ] Both are identical
...
- [x] Observe and debug digital signals
- [ ] Store configuration data
...
- [ ] Set all signals LOW
- [x] Initialize the system to a known state
...
- [x] Can cause metastability if not handled carefully
...
- [x] Difference between required and actual arrival time
- [ ] Maximum frequency
- [ ] Minimum setup time
- [ ] Clock period
...
- [ ] Generate clock signals
- [ ] Store configuration data
- [x] Buffer data between circuits operating at different rates
